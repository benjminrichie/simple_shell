#ifndef MYSHELLHEADER_H
#define MYSHELLHEADER_H
...
/* This is for the read/write buffers */
#define READ_BUF_SIZE 1024
#define WRITE_BUF_SIZE 1024
#define BUF_FLUSH -1

/* command chaining define */
#define CMD_NORM	0
#define CMD_OR		1
#define CMD_AND		2
#define CMD_CHAIN	3

/* for convert_number() define*/
#define CONVERT_LOWERCASE	1
#define CONVERT_UNSIGNED	2

/* This is 1 if using system getline() */
